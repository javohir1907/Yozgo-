    ...
    <div className="space-y-6 pb-6">
      ...
      <div className="space-y-4">
        {notifications.map((notif, i) => (
          <div key={i} className="bg-secondaryBg rounded-2xl p-5 border border-hint/10 relative overflow-hidden">
             ...
             <div className="flex justify-between items-start mb-2">
                ...
                <span className="text-[10px] bg-primary/10 text-primary px-2 py-0.5 rounded font-bold whitespace-nowrap">Yangi</span>
             </div>
