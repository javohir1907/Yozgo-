  ...
  return (
    <div className="space-y-6 pb-4">
      <div className="flex flex-col items-center justify-center text-center mt-4">
        ...
        <p className="text-hint text-sm font-medium">
          Barcha vaqtlardagi eng yaxshi ishtirokchilar
        </p>
      </div>
      ...
      <div className="space-y-3">
        {leaders.map((leader, i) => {
          const isMe =
            ...
            user?.firstName === leader.username ||
            user?.email?.split("@")[0] === leader.username;
          return (
            <div
              key={i}
            ...
            >
              ...
              <div className="w-12 h-12 rounded-full overflow-hidden border-2 border-primary/20 bg-background shrink-0">
                <img
                  src={
                    leader.avatarUrl ||
                    "https://api.dicebear.com/7.x/avataaars/svg?seed=" + leader.username
                  }
                  alt="User"
                />
              </div>
              ...
              <div className="flex-1 min-w-0">
                <h3 className="font-bold text-base truncate flex items-center gap-2">
                  {leader.username}
                  {isMe && (
                    <span className="text-[9px] bg-primary text-white uppercase px-1.5 py-0.5 rounded-sm">
                      Men
                    </span>
                  )}
                </h3>
                <p className="text-xs text-hint uppercase tracking-wider font-semibold">
                  {leader.language} tili
                </p>
              </div>
              ...
              <div className="text-right shrink-0">
                ...
                <div className="text-[10px] text-hint uppercase font-bold tracking-widest leading-none">
                  WPM
                </div>
              </div>
            </div>
